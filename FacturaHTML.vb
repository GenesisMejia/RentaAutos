...
Module FacturaHTML
    ...
    Public Sub ImpresionFisica()
        ...
        web &= "<b><p style='font-family:Georgia;font-size:90%;'>RENTA FÁCIL</b>"
        web &= "<p style='font-family:courier;font-size:80%;'>"
        web &= "Traslados de confianza<br>"
        web &= "Permiso # 123-456"
        ...
        web &= "Av. de los Hornos #4568<br>"
        web &= "Monclova, Coahuila<br>"
        web &= "Teléfono: (866)131-54-47 <br>"
